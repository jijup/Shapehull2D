...
// $Id: Triangulation_ds_face_base_2.h 56667 2010-06-09 07:37:13Z sloriot $
// 
//
...
public:
  ...
  void ccw_permute();
  void cw_permute();
  void set_cradius(double r);
  //by me
  //void set_face_area();
  //void set_face_area(Vertex_handle v0, Vertex_handle v1, Vertex_handle v2);
  //double face_area(); 
...
set_face_area()
{
	...
	result=compute_area_2(v[0]->point(),v[1]->point(),v[2]->point());
}

template <class TDS>      
inline void
Triangulation_ds_face_base_2<TDS> ::     
set_face_area(Vertex_handle v0, Vertex_handle v1, Vertex_handle v2)
{
	
	typename Traits::Compute_area_2 compute_area_2 =
            traits.compute_area_2_object();

	result=compute_area_2(v0->point(),v1->point(),v2->point());
}
template <class TDS>      
inline double
Triangulation_ds_face_base_2<TDS> ::     
