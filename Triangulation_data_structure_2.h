...
//
// $URL: svn+ssh://scm.gforge.inria.fr/svn/cgal/branches/releases/CGAL-3.9-branch/Triangulation_2/include/CGAL/Triangulation_data_structure_2.h $
...
#include "Triangulation_ds_face_base_2.h"
...
// 		  FaceIt face_end);
 ...
 Face_handle create_face(Face_handle f1, int i1, 
  ...
  void set_cradius(Face_handle f, double r);
...
void
Triangulation_data_structure_2<Vb,Fb>::
set_cradius(Face_handle f, double r)
{
	f->radius=r;
}
