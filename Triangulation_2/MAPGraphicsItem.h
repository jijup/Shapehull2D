...
template <typename T>
class MAPGraphicsItem : public GraphicsItem
{
  typedef typename T::Geom_traits Geom_traits;
public:
  MAPGraphicsItem(T* t_);
...
template <typename T>
MAPGraphicsItem<T>::MAPGraphicsItem(T * t_)
...
template <typename T>
QRectF 
MAPGraphicsItem<T>::boundingRect() const
{
...
template <typename T>
void 
MAPGraphicsItem<T>::operator()(typename T::Face_handle fh)
{
  if(visible_edges) {
    for (int i=0; i<3; i++) {
...
template <typename T>
void 
MAPGraphicsItem<T>::drawAll(QPainter *painter)
{
...
template <typename T>
void 
MAPGraphicsItem<T>::paintVertices(QPainter *painter)
{
  if(visibleVertices()) {
...
template <typename T>
void 
MAPGraphicsItem<T>::paintOneVertex(const typename T::Point& point)
{
  Converter<Geom_traits> convert;
...
template <typename T>
void 
MAPGraphicsItem<T>::paintVertex(typename T::Vertex_handle vh)
{
  Converter<Geom_traits> convert;
...
template <typename T>
void 
MAPGraphicsItem<T>::paint(QPainter *painter, 
...
template <typename T>
void 
MAPGraphicsItem<T>::updateBoundingBox()
{
...
template <typename T>
void 
MAPGraphicsItem<T>::modelChanged()
{
  if((t->number_of_vertices() == 0) ){
    this->hide();
